...
const Footer = () => {
    return (
        <footer className="flex flex-row gap-20 space-x-4 items-center md:px-36 py-20 bg-[#151515] text-white">
            <div className="flex-1 flex flex-col gap-4">
                <div className="flex gap-4">
                    <img className="w-[35px] h-[35px] rounded-lg" src="https://i.ibb.co/wNWNMrj/blog-icon.png" />
                    <h6 className="bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-orange-500 text-2xl font-bold">Chronicle </h6>
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-orange-500 text-2xl font-bold -ml-2">Whisper</span>
                </div>
                <p className="w-full">We publish blog on different topics and our user can publish their own blog. We encourage the writers to be creative and mindful.</p>
                <div className="flex gap-8">
                    <button className="btn-xs btn-circle pl-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                            <path d="M20 40C31.0457 40 40 31.0457 40 20C40 8.9543 31.0457 0 20 0C8.9543 0 0 8.9543 0 20C0 31.0457 8.9543 40 20 40Z" fill="none" />
                            <path d="M26.5033 6.13892H22.0728C19.4436 6.13892 16.5192 7.24472 16.5192 11.0559C16.532 12.3838 16.5192 13.6556 16.5192 15.0869H13.4775V19.927H16.6133V33.861H22.3754V19.8351H26.1786L26.5227 15.0733H22.2761C22.2761 15.0733 22.2856 12.9551 22.2761 12.3399C22.2761 10.8339 23.8432 10.9201 23.9375 10.9201C24.6832 10.9201 26.1332 10.9223 26.5055 10.9201V6.13892H26.5033Z" fill="white" />
                        </svg>
                    </button>
                    <button className="btn-xs btn-circle pl-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
            ...
            <div className="flex items-center md:gap-28 space-x-8 ">
                ...
                <nav>
                    <header className=" text-lg font-semibold mb-4 text-white">Features</header>
                    <div className="flex flex-col space-y-4 font-light text-[#f3f3f3]">
                        <h6 className="link link-hover">Top Post</h6>
                        <h6 className="link link-hover">Authors</h6>
                        <h6 className="link link-hover">Tags</h6>
                    </div>
                </nav>
                <nav>
                    <header className=" text-lg font-semibold mb-4 text-white">Support</header>
                    <div className="flex flex-col space-y-4 font-light text-[#f3f3f3]">
                        <h6 className="link link-hover">Feedback</h6>
                        <h6 className="link link-hover">Accessibility</h6>
                        <h6 className="link link-hover">Membership</h6>
                    </div>
                </nav>
            </div>
        </footer>
